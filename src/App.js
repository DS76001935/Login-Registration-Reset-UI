...
const App = () => {
  ...
  return (
    <div>
      <nav className="navbar navbar-expand navbar-dark bg-skyblue">
        <Link to={"/"} className="navbar-brand action-center">
          Action Centre
        </Link>
        <div className="navbar-nav mr-auto">
          <li className="nav-item">
            <Link to={"/home"} className="nav-link home-button">
              Home
            </Link>
          </li>
          {showModeratorBoard && (
      ...
      <div className="container mt-3">
        <Routes>
          ...
          <Route path="/redirectToResetPage" element={<ResetComponent />} />
        </Routes>
      </div>
